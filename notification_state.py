"""Discord change detection and heartbeat state for v3.9.3.
...
STATE_VERSION = "notification-v393-r1"
...
def report_send_decision(
    *,
    ...
    state = _load(path)
    # v3.9.3 has no trailing clock in the header. Normalize whitespace only.
