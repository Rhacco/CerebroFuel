"""Discord change detection and heartbeat state for v3.8.2.
...
STATE_VERSION = "notification-v382-r1"
...
def report_send_decision(
    *,
    ...
    state = _load(path)
    # v3.8.2 has no trailing clock in the header. Normalize whitespace only.
